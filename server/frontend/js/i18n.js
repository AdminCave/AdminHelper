...
const translations = {
  de: {
    ...
    "modal.check.agentResourcesHint": "Wertet Metriken vom srm-monitor-agent aus. Der Agent muss auf dem Server installiert und konfiguriert sein.",
  ...
  en: {
    ...
    "modal.check.agentResourcesHint": "Evaluates metrics from srm-monitor-agent. The agent must be installed and configured on the server.",
