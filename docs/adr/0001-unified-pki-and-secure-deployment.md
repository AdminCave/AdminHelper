...
| D3 mTLS-Pflicht `:443` | ✅ **enforced** per Default (ab 0.29.0, Code + Compose); Permissiv-Rollout per `MTLS_ENFORCE=false` (Schalter umgesetzt + **end-to-end verifiziert**: permissiv↔enforced↔rollback, A8) |
