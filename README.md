...
```bash
curl -fsSL https://raw.githubusercontent.com/ks98/AdminHelper/v0.30.1/scripts/install.sh \
  | bash -s -- --domain srm.example.com --ref v0.30.1
```
...
```bash
# Install the DEB:
sudo apt install ./adminhelper-agent_0.30.1_amd64.deb
