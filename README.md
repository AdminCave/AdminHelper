...
```bash
curl -fsSL https://raw.githubusercontent.com/ks98/AdminHelper/v0.32.0/scripts/install.sh \
  | bash -s -- --domain srm.example.com --ref v0.32.0
```
...
```bash
# Install the DEB:
sudo apt install ./adminhelper-agent_0.32.0_amd64.deb
