...
(abgeschaltete Tests im Diff; ein ganzer Test darf gehen, wenn die Task ihn als
`Test-Löschung:` ankündigt, siehe `tasks/README.md`), `review.sh scope` (Fremd-Pfade) und `review.sh sec`
