...
### T1 — NTP-Slew-Guard für die agent_ping-Staleness  [x] (Monoton-Companion + 60s-Toleranz; 10 Tests inkl. beider Sprungrichtungen, wiederholter Sprünge, Toleranzgrenze und Alerter-Inhibition. Zwei Review-Runden: Task-Review fand die falsch benannte Uhr; der xhigh-Branch-Review fand den Konstruktionsfehler — der Guard warf mono_age weg und setzte auf `now`, wodurch ein toter Agent als frisch galt (False-Recovery) und `unknown` die Host-down-Inhibition löste. Jetzt Korrektur statt Abbruch: Anker auf `now - mono_age`, Bewertung läuft normal weiter. Restlücke dokumentiert: Neustart direkt nach einem Sprung fällt bis zum nächsten Push auf Wanduhr zurück.)
