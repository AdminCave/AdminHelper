...
{:else if name === 'docker'}
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <path d="M17 11h4.5a2 2 0 0 1-2 3H2c0 3 2 6 6 6h7c4 0 6-3 6-6" />
  </svg>
{:else if name === 'backups'}
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    <rect x="3" y="4" width="18" height="16" rx="2" />
    <path d="M3 10h18M8 14h2M14 14h2M8 18h8" />
  </svg>
...
{:else if name === 'smart'}
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    <path d="M14 2l-6 6v4l-2 2v6l2 2h8l2-2v-6l-2-2V8l-6-6z" opacity="0.1" />
    <path d="M12 2v20M8 7h8M8 12h8M8 17h8" />
  </svg>
