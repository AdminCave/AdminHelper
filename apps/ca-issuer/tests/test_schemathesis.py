...
# The list is empty today. The loader still enforces the two kinds, so the first
# entry someone adds cannot quietly waive not_a_server_error along with the check
